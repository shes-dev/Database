<?php
	...
	$sql = "SELECT inputNumber,updateNumber FROM input_table WHERE updateToInput = '$requestedInputNumber' ORDER BY timestamp DESC LIMIT 1";
	...
	//z_table
	$sql = "SELECT * FROM z_table WHERE number = '$requestedInputNumber' ORDER BY timestamp DESC";
	$query = mysqli_query($con,$sql);
	...
	//bb_table
	$sql = "SELECT * FROM bb_table WHERE number = '$requestedInputNumber' ORDER BY timestamp DESC";
	$query = mysqli_query($con,$sql);
